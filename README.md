...
## motor is sim1
### dial/user limit are different in epics and sardana. There are seperate concepts. Users can define both of them in epics and sardana, the ranges must be valid, but the ranges can be different. The range of the epics PV >= the range of sardana motor.     
